 ...
 * @Last Modified time: 2016-11-10 18:08:53
 */
 -->
 <!doctype html>
<html>
	...
	<script>
		...
		$(function(){
			...
			$("#begin").click(function(){
				...
				var youxiLiHtml2 = '<li class="on"> <div class="d1"> <img src="imagesbak/weixuanzhong.jpg"> </div> <div class="d2"> <img src=""> </div> </li>';
				for(i = 0; i < 9; i++){
					if(i == 0 || i == 3 || i == 6){
				...
				$("#youxiqu").delay(300).fadeOut(function(){
					$(this).html(beginHtml);
					//初始化
			    	...
			    	function panduan(){
			            for(i=0;i<jiangpin;i++){
			                if(caseNo[i]==3){
                                setTimeout(function(){document.location.href="zhong.php"}, 100)
			                        ...
			                        for (var i = 0; i < surplus; i++) {
			                            ...
			                            for(var j = 0; j < 9; j++){//9宫格
			                                ...
			                                if(!fanpaiLi.eq(j).is(open)){
			                                    ...
			                                    jiangpinImgOther.attr("src",imgUrl[jiangNo]).css("width","100%").fadeIn().parents(".d2").height('auto');
			                                    bgImgOther.delay("300").fadeOut().parents(".d1").height(0);
			                                    setTimeout(function(){document.location.href="zhong.php"}, 1700)
			                                    break;
			                                }
			                            }
			                        }; 
			                    }
			                }).parents(".d2").height('auto');
			                // chanceD.html(chance);
			            }).parents('.d1').height(0);
			        }
	...
	<script>
		$(function(){
	    	...
	    	$(window).bind("load resize",function(){
	    		...
	    		var sizeText = "94% "+ (windowH*0.7+70) +"px";
	    		var positionText2 = "center "+ windowH*0.05 +"px";
	    		var sizeText2 = "94% "+ (windowH*0.6+70) +"px";
	    		$(".shuangTan").css({
	    			"width":windowW,
	    			"height":windowH,
