...
<body>
    <div class="main" style="background:url(imagesbak/test.jpg) no-repeat center top / 100% 100%;width:100%;height:480px;">
	    <!-- 规则 -->
		...
		<!-- 中奖记录 -->
		<div class="tan shuangTan shuangTan2" style="display:block">
			<h2>中奖记录</h2>
